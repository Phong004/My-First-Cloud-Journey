...
1. **Verify ECS Clusters and Services Status:**
   ...
   ![ECS Services list](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-1.png)
   
   - Ensure all services have been deployed successfully and show **Active** status.
   
   ![Service deployment status](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-2.png)
   
   - Verify that the number of **Running Tasks** matches the desired configuration deployed by Terraform.
   
   ![Check Running Tasks](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-3.png)

2. **Verify Target Groups on the Application Load Balancer:**
   - To verify container routing, go to the **EC2 Console**.
   
   ![Search for EC2](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-4.png)
   ...
   ![Select the internal ALB](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-6.png)
   
   - Switch to the **Listeners and rules** tab to verify that the routing rules are configured correctly.
   
   ![Check Listeners and Rules](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-7.png)
   ...
   ![Healthy Target Groups status](/My-First-Cloud-Journey/images/4-Workshop/4.4-Verify-backend/image-8.png)
