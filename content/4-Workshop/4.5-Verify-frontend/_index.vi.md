...
1. **Kiểm tra Amazon API Gateway:**
   ...
   ![Tìm kiếm API Gateway](/images/4.5-Verify-frontend/image.png)
   
   - Chọn API đã được triển khai (ví dụ: `fpt-event-api`).
   
   ![Chọn API Gateway fpt-event-api](/images/4.5-Verify-frontend/image-1.png)
   
   - Kiểm tra các Routes đã được cấu hình đầy đủ để trỏ tới các microservices chưa.
   
   ![Kiểm tra các Routes của API](/images/4.5-Verify-frontend/image-2.png)
...
2. **Kiểm tra Amazon S3 & CloudFront:**
   ...
   ![Tìm kiếm CloudFront](/images/4.5-Verify-frontend/image-6.png)
   
   - Click chọn vào menu **Distributions**.
   
   ![Chọn Distributions](/images/4.5-Verify-frontend/image-7.png)
   
   - Trải nghiệm trang web bằng cách sao chép và đi đến đường dẫn của **Distribution domain name**.
   
   ![Lấy Tên miền URL CloudFront](/images/4.5-Verify-frontend/image-8.png)
   
   - Giao diện của trang web sẽ hiển thị nếu triển khai hoạt động ổn định.
   
   ![Giao diện hệ thống ReactJS](/images/4.5-Verify-frontend/image-3.png)
...
3. **Kiểm tra AWS WAF (Web Application Firewall):**
   ...
   ![Trang WAF](/images/4.5-Verify-frontend/image-4.png)
   
   ![Xác nhận cấu hình WAF](/images/4.5-Verify-frontend/image-5.png)