...
![Tìm kiếm API Gateway](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image.png)

- Chọn API đã được triển khai (ví dụ: `fpt-event-api`).

![Chọn API fpt-event-api](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-1.png)

- Kiểm tra các Routes để đảm bảo đã được cấu hình đầy đủ trỏ tới các microservice.

![Kiểm tra Routes của API Gateway](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-2.png)
...
![Tìm kiếm CloudFront](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-6.png)

- Chọn **Distributions** từ menu bên trái.

![Chọn Distributions](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-7.png)

- Sao chép **Distribution domain name** và mở trên trình duyệt để truy cập trang web.

![Lấy Domain Name của CloudFront](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-8.png)

- Giao diện ReactJS hiển thị thành công xác nhận toàn bộ hệ thống hoạt động ổn định.

![Giao diện trang web ReactJS](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-3.png)
...
![Trang WAF & Shield](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-4.png)

- Xác nhận Web ACL đã được tạo và gắn (associated) đúng vào CloudFront Distribution.

![Xác nhận cấu hình WAF trên CloudFront](/My-First-Cloud-Journey/images/4-workshop/4.5-verify-frontend/image-5.png)