...
1. **Kiểm tra Amazon API Gateway:**
   ...
   ![Chọn API Gateway fpt-event-api](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-1.png)
   
   - Kiểm tra các Routes đã được cấu hình đầy đủ để trỏ tới các microservices chưa.
   
   ![Kiểm tra các Routes của API](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-2.png)
...
2. **Kiểm tra Amazon S3 & CloudFront:**
   ...
   ![Lấy Tên miền URL CloudFront](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-8.png)
   
   - Giao diện của trang web sẽ hiển thị nếu triển khai hoạt động ổn định.
   
   ![Giao diện hệ thống ReactJS](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-3.png)
...
3. **Kiểm tra AWS WAF (Web Application Firewall):**
   ...
   ![Trang WAF](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-4.png)
   
   ![Xác nhận cấu hình WAF](/My-First-Cloud-Journey/images/4-Workshop/4.5-Verify-frontend/image-5.png)