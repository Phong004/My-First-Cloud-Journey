...
![Tìm kiếm dịch vụ S3](/My-First-Cloud-Journey/images/4-Workshop/4.6-Cleanup/image.png)

- Chọn bucket của Frontend (ví dụ: `fpt-event-bucket`).

![Chọn fpt-event-bucket](/My-First-Cloud-Journey/images/4-Workshop/4.6-Cleanup/image-1.png)

- Tích chọn bucket (hoặc các object bên trong) và nhấn nút **Delete**.

![Chọn Delete](/My-First-Cloud-Journey/images/4-Workshop/4.6-Cleanup/image-2.png)

- Gõ cụm từ **permanently delete** (xóa vĩnh viễn) vào ô xác nhận hệ thống và thực hiện xóa.

![Chấp nhận permanently delete](/My-First-Cloud-Journey/images/4-Workshop/4.6-Cleanup/image-3.png)
