...
![Tìm kiếm dịch vụ S3](/images/4.6-Cleanup/image.png)

- Chọn bucket của Frontend (ví dụ: `fpt-event-bucket`).

![Chọn fpt-event-bucket](/images/4.6-Cleanup/image-1.png)

- Tích chọn bucket (hoặc các object bên trong) và nhấn nút **Delete**.

![Chọn Delete](/images/4.6-Cleanup/image-2.png)

- Gõ cụm từ **permanently delete** (xóa vĩnh viễn) vào ô xác nhận hệ thống và thực hiện xóa.

![Chấp nhận permanently delete](/images/4.6-Cleanup/image-3.png)
