...
```markdown
![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png)
```
...
```markdown
![Alt text](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg "The Stormtroopocat")
```
...
[id]: https://octodex.github.com/My-First-Cloud-Journey/images/dojocat.jpg "The Dojocat"
...
```markdown
![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?width=20pc)
```

![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?width=20pc)

```markdown
![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?height=50px)
```

![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?height=50px)

```markdown
![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?height=50px&width=300px)
```
...
```markdown
![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?classes=shadow)
```

![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?width=40pc&classes=shadow)

```markdown
![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?classes=border)
```

![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?width=40pc&classes=border)

```markdown
![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?classes=border,shadow)
```

![stormtroopocat](https://octodex.github.com/My-First-Cloud-Journey/images/stormtroopocat.jpg?width=40pc&classes=border,shadow)
...
```markdown
![Minion](https://octodex.github.com/My-First-Cloud-Journey/images/minion.png?featherlight=false)
```
