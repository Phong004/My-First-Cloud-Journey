...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/My-First-Cloud-Journey/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/My-First-Cloud-Journey/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/My-First-Cloud-Journey/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/My-First-Cloud-Journey/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/My-First-Cloud-Journey/images/green-variant.png?width=60pc)
